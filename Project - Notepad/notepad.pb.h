...
template<> ::notepad::VERSION* Arena::CreateMaybeMessage<::notepad::VERSION>(Arena*);
...
class GIST final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD std::string* release_previous();
...
class VERSION_POINTER final :
 ...
 public:
  ...
  const std::string& version_no() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_version_no(ArgT0&& arg0, ArgT... args);
  std::string* mutable_version_no();
  PROTOBUF_NODISCARD std::string* release_version_no();
  void set_allocated_version_no(std::string* version_no);
  private:
  const std::string& _internal_version_no() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_version_no(const std::string& value);
  std::string* _internal_mutable_version_no();
  public:
  ...
  // string gist = 7;
  void clear_gist();
  const std::string& gist() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_gist(ArgT0&& arg0, ArgT... args);
  std::string* mutable_gist();
  PROTOBUF_NODISCARD std::string* release_gist();
  void set_allocated_gist(std::string* gist);
  private:
  const std::string& _internal_gist() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_gist(const std::string& value);
  std::string* _internal_mutable_gist();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr id_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr version_no_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr project_id_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr path_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr time_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr gist_;
    int32_t count_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class VERSION final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:notepad.VERSION) */ {
 public:
  ...
  public:
  void clear_version();
  ::notepad::VERSION_POINTER* mutable_version(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::notepad::VERSION_POINTER >*
      mutable_version();
  private:
  const ::notepad::VERSION_POINTER& _internal_version(int index) const;
  ::notepad::VERSION_POINTER* _internal_add_version();
  public:
  const ::notepad::VERSION_POINTER& version(int index) const;
  ::notepad::VERSION_POINTER* add_version();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::notepad::VERSION_POINTER >&
      version() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::notepad::VERSION_POINTER > version_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_notepad_2eproto;
...
// string previous = 1;
inline void GIST::clear_previous() {
  _impl_.previous_.ClearToEmpty();
}
inline const std::string& GIST::previous() const {
  // @@protoc_insertion_point(field_get:notepad.GIST.previous)
  return _internal_previous();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GIST::set_previous(ArgT0&& arg0, ArgT... args) {
 
 _impl_.previous_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notepad.GIST.previous)
}
inline std::string* GIST::mutable_previous() {
  std::string* _s = _internal_mutable_previous();
  // @@protoc_insertion_point(field_mutable:notepad.GIST.previous)
  return _s;
}
inline const std::string& GIST::_internal_previous() const {
  return _impl_.previous_.Get();
}
inline void GIST::_internal_set_previous(const std::string& value) {
  
  _impl_.previous_.Set(value, GetArenaForAllocation());
}
inline std::string* GIST::_internal_mutable_previous() {
  
  return _impl_.previous_.Mutable(GetArenaForAllocation());
}
inline std::string* GIST::release_previous() {
  // @@protoc_insertion_point(field_release:notepad.GIST.previous)
  return _impl_.previous_.Release();
}
inline void GIST::set_allocated_previous(std::string* previous) {
  if (previous != nullptr) {
    
  } else {
    
  }
  _impl_.previous_.SetAllocated(previous, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.previous_.IsDefault()) {
    _impl_.previous_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notepad.GIST.previous)
}

// string next = 2;
inline void GIST::clear_next() {
  _impl_.next_.ClearToEmpty();
}
inline const std::string& GIST::next() const {
  // @@protoc_insertion_point(field_get:notepad.GIST.next)
  return _internal_next();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GIST::set_next(ArgT0&& arg0, ArgT... args) {
 
 _impl_.next_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notepad.GIST.next)
}
inline std::string* GIST::mutable_next() {
  std::string* _s = _internal_mutable_next();
  // @@protoc_insertion_point(field_mutable:notepad.GIST.next)
  return _s;
}
inline const std::string& GIST::_internal_next() const {
  return _impl_.next_.Get();
}
inline void GIST::_internal_set_next(const std::string& value) {
  
  _impl_.next_.Set(value, GetArenaForAllocation());
}
inline std::string* GIST::_internal_mutable_next() {
  
  return _impl_.next_.Mutable(GetArenaForAllocation());
}
inline std::string* GIST::release_next() {
  // @@protoc_insertion_point(field_release:notepad.GIST.next)
  return _impl_.next_.Release();
}
inline void GIST::set_allocated_next(std::string* next) {
  if (next != nullptr) {
    
  } else {
    
  }
  _impl_.next_.SetAllocated(next, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.next_.IsDefault()) {
    _impl_.next_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notepad.GIST.next)
}

// string operation = 3;
inline void GIST::clear_operation() {
  _impl_.operation_.ClearToEmpty();
}
inline const std::string& GIST::operation() const {
  // @@protoc_insertion_point(field_get:notepad.GIST.operation)
  return _internal_operation();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GIST::set_operation(ArgT0&& arg0, ArgT... args) {
 
 _impl_.operation_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notepad.GIST.operation)
}
inline std::string* GIST::mutable_operation() {
  std::string* _s = _internal_mutable_operation();
  // @@protoc_insertion_point(field_mutable:notepad.GIST.operation)
  return _s;
}
inline const std::string& GIST::_internal_operation() const {
  return _impl_.operation_.Get();
}
inline void GIST::_internal_set_operation(const std::string& value) {
  
  _impl_.operation_.Set(value, GetArenaForAllocation());
}
inline std::string* GIST::_internal_mutable_operation() {
  
  return _impl_.operation_.Mutable(GetArenaForAllocation());
}
inline std::string* GIST::release_operation() {
  // @@protoc_insertion_point(field_release:notepad.GIST.operation)
  return _impl_.operation_.Release();
}
inline void GIST::set_allocated_operation(std::string* operation) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notepad.GIST.operation)
}

// int32 line = 4;
inline void GIST::clear_line() {
  _impl_.line_ = 0;
}
inline int32_t GIST::_internal_line() const {
  return _impl_.line_;
}
inline int32_t GIST::line() const {
  // @@protoc_insertion_point(field_get:notepad.GIST.line)
  return _internal_line();
}
inline void GIST::_internal_set_line(int32_t value) {
  
  _impl_.line_ = value;
}
inline void GIST::set_line(int32_t value) {
  _internal_set_line(value);
  // @@protoc_insertion_point(field_set:notepad.GIST.line)
}
...
inline const std::string& PROJECT::time() const {
  // @@protoc_insertion_point(field_get:notepad.PROJECT.time)
  return _internal_time();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PROJECT::set_time(ArgT0&& arg0, ArgT... args) {
 
 _impl_.time_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notepad.PROJECT.time)
}
inline std::string* PROJECT::mutable_time() {
  std::string* _s = _internal_mutable_time();
  // @@protoc_insertion_point(field_mutable:notepad.PROJECT.time)
  return _s;
}
inline const std::string& PROJECT::_internal_time() const {
  return _impl_.time_.Get();
}
inline void PROJECT::_internal_set_time(const std::string& value) {
  
  _impl_.time_.Set(value, GetArenaForAllocation());
}
inline std::string* PROJECT::_internal_mutable_time() {
  
  return _impl_.time_.Mutable(GetArenaForAllocation());
}
inline std::string* PROJECT::release_time() {
  // @@protoc_insertion_point(field_release:notepad.PROJECT.time)
  return _impl_.time_.Release();
}
inline void PROJECT::set_allocated_time(std::string* time) {
  if (time != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notepad.PROJECT.time)
}
...
inline const std::string& VERSION_POINTER::version_no() const {
  // @@protoc_insertion_point(field_get:notepad.VERSION_POINTER.version_no)
  return _internal_version_no();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void VERSION_POINTER::set_version_no(ArgT0&& arg0, ArgT... args) {
 
 _impl_.version_no_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notepad.VERSION_POINTER.version_no)
}
inline std::string* VERSION_POINTER::mutable_version_no() {
  std::string* _s = _internal_mutable_version_no();
  // @@protoc_insertion_point(field_mutable:notepad.VERSION_POINTER.version_no)
  return _s;
}
inline const std::string& VERSION_POINTER::_internal_version_no() const {
  return _impl_.version_no_.Get();
}
inline void VERSION_POINTER::_internal_set_version_no(const std::string& value) {
  
  _impl_.version_no_.Set(value, GetArenaForAllocation());
}
inline std::string* VERSION_POINTER::_internal_mutable_version_no() {
  
  return _impl_.version_no_.Mutable(GetArenaForAllocation());
}
inline std::string* VERSION_POINTER::release_version_no() {
  // @@protoc_insertion_point(field_release:notepad.VERSION_POINTER.version_no)
  return _impl_.version_no_.Release();
}
inline void VERSION_POINTER::set_allocated_version_no(std::string* version_no) {
  if (version_no != nullptr) {
    
  } else {
    
  }
  _impl_.version_no_.SetAllocated(version_no, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.version_no_.IsDefault()) {
    _impl_.version_no_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notepad.VERSION_POINTER.version_no)
}
...
// string path = 4;
inline void VERSION_POINTER::clear_path() {
  _impl_.path_.ClearToEmpty();
}
inline const std::string& VERSION_POINTER::path() const {
  // @@protoc_insertion_point(field_get:notepad.VERSION_POINTER.path)
  return _internal_path();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void VERSION_POINTER::set_path(ArgT0&& arg0, ArgT... args) {
 
 _impl_.path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notepad.VERSION_POINTER.path)
}
inline std::string* VERSION_POINTER::mutable_path() {
  std::string* _s = _internal_mutable_path();
  // @@protoc_insertion_point(field_mutable:notepad.VERSION_POINTER.path)
  return _s;
}
inline const std::string& VERSION_POINTER::_internal_path() const {
  return _impl_.path_.Get();
}
inline void VERSION_POINTER::_internal_set_path(const std::string& value) {
  
  _impl_.path_.Set(value, GetArenaForAllocation());
}
inline std::string* VERSION_POINTER::_internal_mutable_path() {
  
  return _impl_.path_.Mutable(GetArenaForAllocation());
}
inline std::string* VERSION_POINTER::release_path() {
  // @@protoc_insertion_point(field_release:notepad.VERSION_POINTER.path)
  return _impl_.path_.Release();
}
inline void VERSION_POINTER::set_allocated_path(std::string* path) {
  if (path != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notepad.VERSION_POINTER.path)
}

// int32 count = 5;
inline void VERSION_POINTER::clear_count() {
  _impl_.count_ = 0;
}
inline int32_t VERSION_POINTER::_internal_count() const {
  return _impl_.count_;
}
inline int32_t VERSION_POINTER::count() const {
  // @@protoc_insertion_point(field_get:notepad.VERSION_POINTER.count)
  return _internal_count();
}
inline void VERSION_POINTER::_internal_set_count(int32_t value) {
  
  _impl_.count_ = value;
}
inline void VERSION_POINTER::set_count(int32_t value) {
  _internal_set_count(value);
  // @@protoc_insertion_point(field_set:notepad.VERSION_POINTER.count)
}
...
// string gist = 7;
inline void VERSION_POINTER::clear_gist() {
  _impl_.gist_.ClearToEmpty();
}
inline const std::string& VERSION_POINTER::gist() const {
  // @@protoc_insertion_point(field_get:notepad.VERSION_POINTER.gist)
  return _internal_gist();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void VERSION_POINTER::set_gist(ArgT0&& arg0, ArgT... args) {
 
 _impl_.gist_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notepad.VERSION_POINTER.gist)
}
inline std::string* VERSION_POINTER::mutable_gist() {
  std::string* _s = _internal_mutable_gist();
  // @@protoc_insertion_point(field_mutable:notepad.VERSION_POINTER.gist)
  return _s;
}
inline const std::string& VERSION_POINTER::_internal_gist() const {
  return _impl_.gist_.Get();
}
inline void VERSION_POINTER::_internal_set_gist(const std::string& value) {
  
  _impl_.gist_.Set(value, GetArenaForAllocation());
}
inline std::string* VERSION_POINTER::_internal_mutable_gist() {
  
  return _impl_.gist_.Mutable(GetArenaForAllocation());
}
inline std::string* VERSION_POINTER::release_gist() {
  // @@protoc_insertion_point(field_release:notepad.VERSION_POINTER.gist)
  return _impl_.gist_.Release();
}
inline void VERSION_POINTER::set_allocated_gist(std::string* gist) {
  if (gist != nullptr) {
    
  } else {
    
  }
  _impl_.gist_.SetAllocated(gist, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.gist_.IsDefault()) {
    _impl_.gist_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notepad.VERSION_POINTER.gist)
}
...
// repeated .notepad.VERSION_POINTER version = 1;
inline int VERSION::_internal_version_size() const {
  return _impl_.version_.size();
}
inline int VERSION::version_size() const {
  return _internal_version_size();
}
inline void VERSION::clear_version() {
  _impl_.version_.Clear();
}
inline ::notepad::VERSION_POINTER* VERSION::mutable_version(int index) {
  // @@protoc_insertion_point(field_mutable:notepad.VERSION.version)
  return _impl_.version_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::notepad::VERSION_POINTER >*
VERSION::mutable_version() {
  // @@protoc_insertion_point(field_mutable_list:notepad.VERSION.version)
  return &_impl_.version_;
}
inline const ::notepad::VERSION_POINTER& VERSION::_internal_version(int index) const {
  return _impl_.version_.Get(index);
}
inline const ::notepad::VERSION_POINTER& VERSION::version(int index) const {
  // @@protoc_insertion_point(field_get:notepad.VERSION.version)
  return _internal_version(index);
}
inline ::notepad::VERSION_POINTER* VERSION::_internal_add_version() {
  return _impl_.version_.Add();
}
inline ::notepad::VERSION_POINTER* VERSION::add_version() {
  ::notepad::VERSION_POINTER* _add = _internal_add_version();
  // @@protoc_insertion_point(field_add:notepad.VERSION.version)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::notepad::VERSION_POINTER >&
VERSION::version() const {
  // @@protoc_insertion_point(field_list:notepad.VERSION.version)
  return _impl_.version_;
}
