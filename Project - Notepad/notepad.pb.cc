...
static ::_pb::Metadata file_level_metadata_notepad_2eproto[6];
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 25, -1, -1, sizeof(::notepad::PROJECT)},
  { 37, -1, -1, sizeof(::notepad::PROJECT_LIST)},
  { 44, -1, -1, sizeof(::notepad::VERSION_POINTER)},
};
...
const char descriptor_table_protodef_notepad_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "OK\022\033\n\004user\030\001 \003(\0132\r.notepad.USER\"\031\n\004GIST\022"
  "\021\n\tgist_line\030\001 \001(\t\"\203\001\n\007PROJECT\022\022\n\nprojec"
  "t_id\030\001 \001(\t\022\024\n\014project_name\030\002 \001(\t\022\017\n\007user"
  "_id\030\003 \001(\t\022\022\n\noperations\030\004 \001(\005\022\014\n\004path\030\005 "
  "\001(\t\022\033\n\004gist\030\006 \003(\0132\r.notepad.GIST\"1\n\014PROJ"
  "ECT_LIST\022!\n\007project\030\001 \003(\0132\020.notepad.PROJ"
  "ECT\"S\n\017VERSION_POINTER\022\n\n\002id\030\001 \001(\t\022\022\n\nve"
  "rsion_no\030\002 \001(\005\022\022\n\nproject_id\030\003 \001(\t\022\014\n\004ti"
  "me\030\004 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_notepad_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_notepad_2eproto = {
    false, false, 456, descriptor_table_protodef_notepad_2eproto,
    "notepad.proto",
    &descriptor_table_notepad_2eproto_once, nullptr, 0, 6,
...
uint8_t* GIST::_InternalSerialize(
  ...
  if (!this->_internal_gist_line().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_gist_line(), target);
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _impl_.version_no_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* VERSION_POINTER::_InternalSerialize(
  ...
  // int32 version_no = 2;
  if (this->_internal_version_no() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(2, this->_internal_version_no(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:notepad.VERSION_POINTER)
  ...
  // int32 version_no = 2;
  if (this->_internal_version_no() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_version_no());
  }
...
void VERSION_POINTER::InternalSwap(VERSION_POINTER* other) {
  ...
  swap(_impl_.version_no_, other->_impl_.version_no_);
}
